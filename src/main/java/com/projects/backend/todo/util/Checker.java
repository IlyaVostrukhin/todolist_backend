package com.projects.backend.todo.util;
...
public final class Checker {
    ...
    public static void emailNotNullAndNotEmpty(String email) {
        if (email == null || email.trim().isEmpty()) {
            throw new IllegalArgumentException("Missing param: EMAIL must not be null or empty");
        }
    }
